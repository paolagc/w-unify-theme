...
<body>
	<header role="banner">
		...
		<div class="topbar" role="menu"> 
			<div class="container" >
				<?php wp_nav_menu( array( 'menu' => 'user' , 'menu_class' => 'list-inline pull-right', )); ?>
			</div>
		</div>
		<!-- End Topbar -->
		...
		<div class="navbar navbar-default mega-menu" role="navigation">
	            <div class="container">
	            	...
	            	<div class="col-md-11" role="menu">
	            		<?php wp_nav_menu( array( 'menu' => 'main' , 'menu_class' => 'nav navbar-nav pull-right' )); ?>
	            	</div>
	            </div>
	    </div>
...
<?php query_posts(array('post_type' => 'dm_slider','order' => 'DESC'));
