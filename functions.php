...
add_action( 'init', 'dm_initialize_cmb_meta_boxes', 9999 );   
function dm_initialize_cmb_meta_boxes() {
...
function slider_init() {
    ...
    register_post_type('dm_slider', $args);
}
...
//add custom fields
add_filter( 'cmb_meta_boxes' , 'dm_create_metaboxes' );
function dm_create_metaboxes( $meta_boxes ) {
	$prefix = 'slider_';
	//PROMOTION SLIDER
	  $meta_boxes[] = array(
		'id' => 'dm_slider_contents',
		'title' => 'Featured Slider',
		'pages' => array('dm_slider'),//Add our post_type() we created earlier.
		'context' => 'normal',
		'priority' => 'low',
		'show_names' => true,
		'fields' => array(
